        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <p class="uppercase_text">Mail-us<br/></p>
              <a href="mailto:bravesdevs1@outlook.com">bravesdevs1@outlook.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Call-us<br/></p>
              <a href="tel:61-1234-5678-09">+91-8306-025-060</a> </div>
